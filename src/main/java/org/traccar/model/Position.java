...
public class Position extends Message {
    ...
    public static final String KEY_BATTERY_LEVEL = "io113"; // percentage
    public static final String KEY_SLOPE_OF_ARM_LEVEL = "slope"; //
    ...
    private String persianFixTime;

    public String getPersianFixTime() {
        return persianFixTime;
    }

    public void setPersianFixTime(String persianFixTime) {
        this.persianFixTime = persianFixTime;
    }
